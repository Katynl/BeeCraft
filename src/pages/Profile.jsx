...
// // Функция для отображения статуса заказа по-русски
...
//   // Загрузка данных профиля и заказов
//   useEffect(() => {
...
//         // Инициализируем форму редактирования после загрузки профиля
//         setEditForm({
...
//       setProfile(response.data); // обновляем данные профиля
//       setIsEditing(false);
//     } catch (err) {
//       console.error(err);
...
//   if (!profile) return <div className="text-center py-20">Нет данных</div>;

//   return (
//     <div className="w-full pb-72  bg-stone-50">
//       <div className="container mx-auto px-4 py-8 pt-72">
//         {/* Шапка профиля */}
//         <div className="flex items-center gap-4 mb-8">
//           <div className="flex justify-between w-full items-end">
//             <h2 className="text-8xl">Добро пожаловать,</h2>
...
//           <div className="md:w-1/3 p-4 shadow rounded-sm hover:shadow-xl flex flex-col justify-center px-12  text-stone-800">
//             <h3 className="text-stone-700 text-left mb-12">Личная информация</h3>
//             <h3 className="text-stone-800 text-2xl text-left">
...
//             <h3 className="text-black/50">Мои заказы</h3>
//             {orders.length === 0 ? (
//               <p>
//                 У вас пока нет заказов.{" "}
//                 <Link to="/catalog" className="text-lime-600 underline">
//                   Перейти в каталог
//                 </Link>
//               </p>
//             ) : (
