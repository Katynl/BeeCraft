        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-10 pr-4 py-3 rounded-sm border font-plexsans border-stone-200 focus:border-[#f4d864] focus:ring-2 focus:ring-[#f4d864]/20 transition outline-none text-stone-700"
            />
          </div>
          <div className="relative">
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="w-full pl-10 pr-12 py-3 rounded-sm border font-plexsans border-stone-200 focus:border-[#f4d864] focus:ring-2 focus:ring-[#f4d864]/20 transition outline-none text-stone-700"
            />
            <button
              type="button"
              onClick={() => setShowPassword(!showPassword)}
              className="absolute right-3 top-1/2 -translate-y-1/2 font-plexsans text-stone-400 hover:text-stone-600 text-xs"
            >
