...
//   return (
//     <div className="container flex flex-col items-center mx-auto px-4 py-52 max-w-3xl">
//       <h1 className="py-6 font-black leading-none tracking-wide font-soledago text-[#f4d864] text-4xl md:text-7xl lg:text-8xl xl:text-9xl">
//         РЕГИСТРАЦИЯ
//       </h1>
//       {error && (
//         <div className="bg-pink-200 text-lime-800 p-3 rounded-lg">{error}</div>
//       )}
...
//           required
//           className="w-full border border-amber-800 rounded p-2 text-black/50"
//         />
...
//           onChange={handleChange}
//           required
//           className="w-full border border-black/50 rounded p-2 text-black/50"
//         />
...
//           onChange={handleChange}
//           className="w-full border border-black/50rounded p-2  text-black/50"
//         />
...
//         <p className="text-stone-400">Уже есть аккаунт?</p>
